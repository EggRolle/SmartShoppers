...
public class AdminWindow{
	...
	private JTextField txtStoreName_2;
	private JTextField txtStoreHours_1;
	 ...
	 */
	public AdminWindow(ShoppersBackend backendi) {
		backend = backendi;
	...
	private void initialize() {
		...
		scrollPane.setBounds(10, 40, 200, 228);
		...
		txtStoreName.setBounds(10, 279, 95, 20);
		...
		btnNewButton_1_3.setBounds(115, 279, 95, 23);
		...
		txtManagerName.setText("Name + Pass");
		txtManagerName.setColumns(10);
		txtManagerName.setBounds(10, 337, 95, 20);
		panel_1.add(txtManagerName);
		
		JButton btnNewButton_1_3_1 = new JButton("Add Manager");
		btnNewButton_1_3_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				backend.addManager(txtManagerName.getText());
			}
		});
		
		
		btnNewButton_1_3_1.setBounds(115, 336, 104, 23);
		panel_1.add(btnNewButton_1_3_1);
		
		JButton btnNewButton_1_3_1_1 = new JButton("Rem Manager");
		btnNewButton_1_3_1_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//backend.currentStore.managers.remove(txtManagerName.getText());
			}
		});
		btnNewButton_1_3_1_1.setBounds(115, 371, 104, 23);
		panel_1.add(btnNewButton_1_3_1_1);
		
		txtStoreName_2 = new JTextField();
		txtStoreName_2.setText("Store Name");
		txtStoreName_2.setColumns(10);
		txtStoreName_2.setBounds(10, 452, 95, 20);
		panel_1.add(txtStoreName_2);
		
		txtStoreHours_1 = new JTextField();
		txtStoreHours_1.setText("Store Hours");
		txtStoreHours_1.setColumns(10);
		txtStoreHours_1.setBounds(10, 483, 95, 20);
		panel_1.add(txtStoreHours_1);
		
		txtStore = new JTextField();
		txtStore.setText("Store Location");
		txtStore.setColumns(10);
		txtStore.setBounds(10, 510, 95, 20);
		panel_1.add(txtStore);
		
		JButton btnNewButton_1_3_1_1_1 = new JButton("Add Store");
		btnNewButton_1_3_1_1_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				backend.storesList.add(new Store(txtStoreName_2.getText(),txtStore.getText(), txtStoreHours_1.getText()));
				listStores();
			}
		});
		btnNewButton_1_3_1_1_1.setBounds(115, 482, 104, 23);
		panel_1.add(btnNewButton_1_3_1_1_1);
		
		JButton btnNewButton_1_3_1_1_2 = new JButton("Rem Store");
		btnNewButton_1_3_1_1_2.setBounds(115, 509, 104, 23);
		panel_1.add(btnNewButton_1_3_1_1_2);
